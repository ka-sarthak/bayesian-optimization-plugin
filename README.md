# bayesian-optimization-hpt

A plugin to conduct BO for Hydrogen plasma treatment
...
```sh
git clone https://github.com/ka-sarthak/bayesian-optimization-hpt.git
cd bayesian-optimization-hpt
...
bayesian-optimization-hpt==x.y.z
```
...
```sh
pip install dist/bayesian-optimization-hpt-0.1.0
```
